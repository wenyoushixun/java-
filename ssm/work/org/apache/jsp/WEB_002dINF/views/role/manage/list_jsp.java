 ...
 * Generated at: 2017-11-16 07:22:52 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.role.manage;
...
return;
    ...
    try {
      ...
      out.write("\n");
      out.write("\n");
      out.write("<div id=\"roleManageListPanel\">\n");
      out.write("\t<div class=\"toolbar-menu-panel\">\n");
      out.write("\t\t<button class=\"btn btn-bg add-role-btn\">添加</button>\n");
      out.write("\t\t<button class=\"btn btn-bg remove-roles-btn\">删除</button>\n");
      out.write("\t</div>\n");
      ...
      out.write("<script>\n");
      out.write("\t$(function() {\n");
      out.write("\t\tvar $roleManageListPanel = $(\"#roleManageListPanel\");\n");
      out.write("\n");
      out.write("\t\t// 添加角色\n");
      out.write("\t\t$roleManageListPanel.find(\".add-role-btn\").on(\"click\", function() {\n");
      out.write("\t\t\tloadMainContent(\"/role/content/add\", function() {\n");
      out.write("\n");
      out.write("\t\t\t}, {\n");
      out.write("\t\t\t\troleId : -1\n");
      out.write("\t\t\t});\n");
      ...
      out.write("\n");
      out.write("\t\t// 编辑角色\n");
      out.write("\t\t$roleManageListPanel.find(\".edit-role-btn\").on(\"click\", function() {\n");
      out.write("\t\t\tvar $this = $(this);\n");
      out.write("\t\t\tvar roleId = $this.parent().parent().data(\"id\");\n");
      out.write("\n");
      out.write("\t\t\tloadMainContent(\"/role/content/add\", function() {\n");
      out.write("\n");
      out.write("\t\t\t}, {\n");
      ...
      out.write("\n");
      out.write("\t\t// 删除角色\n");
      out.write("\t\t$roleManageListPanel.find(\".remove-role-btn\").on(\"click\", function() {\n");
      out.write("\t\t\tvar $this = $(this);\n");
      out.write("\t\t\tvar roleId = $this.parent().parent().data(\"id\");\n");
      out.write("\n");
      out.write("\t\t\t// 操作确认\n");
      out.write("\t\t\tif (!confirm(\"确定删除该角色？\")) {\n");
      out.write("\t\t\t\treturn false;\n");
      out.write("\t\t\t}\n");
      out.write("\n");
      out.write("\t\t\tdoAction(\"/role/content/remove\", {\n");
      out.write("\t\t\t\troleId : roleId\n");
      ...
      out.write("\t\t\n");
      out.write("\t\t// 选中所有\n");
      out.write("\t\t$roleManageListPanel.find(\".check-all-btn\").on(\"click\", function () {\n");
      out.write("\t\t\t// 获取所有复选框数量\n");
      out.write("\t\t\tvar allItemNum = $roleManageListPanel.find(\".role-item-id\").length;\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t// 获取被选中的复选框数量\n");
      out.write("\t\t\tvar checkedItemNum = $roleManageListPanel.find(\".role-item-id:checked\").length;\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t// 对比复选框是否全部被选中\n");
      out.write("\t\t\tvar isChecked = allItemNum === checkedItemNum;\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t// 如果全部被选中，则反选，否则全选\n");
      out.write("\t\t\t$roleManageListPanel.find(\".role-item-id\").prop(\"checked\", !isChecked);\n");
      out.write("\t\t});\n");
      out.write("\t\t\n");
      out.write("\t\t// 删除多个角色\n");
      out.write("\t\t$roleManageListPanel.find(\".remove-roles-btn\").on(\"click\", function () {\n");
      out.write("\t\t\t// 获取被选中复选框\n");
      out.write("\t\t\tvar checkedItems = $roleManageListPanel.find(\".role-item-id:checked\");\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t// 非空判断\n");
      out.write("\t\t\tif (checkedItems.length === 0) {\n");
      out.write("\t\t\t\talert(\"请选择待删除角色！\");\n");
      out.write("\t\t\t\treturn false;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      out.write("\t\t\t// 操作确认\n");
      out.write("\t\t\tif (!confirm(\"确定删除选中角色？\")) {\n");
      out.write("\t\t\t\treturn false;\n");
      out.write("\t\t\t}\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\t\t\n");
      out.write("\t\t\t// 截取多余字符\n");
      out.write("\t\t\troleIds = roleIds.substr(0, roleIds.length - 1);\n");
      out.write("\t\t\t\n");
      out.write("\t\t\tdoAction(\"/role/content/removes\", {\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /WEB-INF/views/role/manage/list.jsp(18,4) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setVar("role");
      // /WEB-INF/views/role/manage/list.jsp(18,4) name = items type = java.lang.Object reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /WEB-INF/views/role/manage/list.jsp(18,4) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      try {
        ...
        if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
          do {
            ...
            out.write("\">\n");
            out.write("\t\t\t\t\t\t<td><input type=\"checkbox\" class=\"role-item-id\" value=\"");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${role.id }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("\">&nbsp;");
            ...
            out.write("</td>\n");
            out.write("\t\t\t\t\t\t<td>");
            out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${role.createTime }", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
            out.write("</td>\n");
            out.write("\t\t\t\t\t\t<td>\n");
            out.write("\t\t\t\t\t\t\t<button class=\"btn btn-xs edit-role-btn\">\n");
            out.write("\t\t\t\t\t\t\t\t<i class=\"fa fa-pencil\"></i>\n");
            out.write("\t\t\t\t\t\t\t</button>\n");
            out.write("\t\t\t\t\t\t\t<button class=\"btn btn-xs remove-role-btn\">\n");
