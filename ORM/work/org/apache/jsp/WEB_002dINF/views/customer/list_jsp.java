 ...
 * Generated at: 2018-01-15 04:10:37 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t<button type=\"button\" class=\"export-customer-btn btn btn-primary\">确定</button>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      ...
      out.write("\t<section id=\"customerTablePanel\" class=\"col-md-6\">\r\n");
      out.write("\t\t<div class=\"row\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"add-customer-btn btn btn-primary\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"excel-customer-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-folder-open-o\"></i> 导出\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"col-md-7\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input class=\"form-control list-search-contact\" name=\"name\" id=\"name\" placeholder=\"客户名...\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"search-customer-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button class=\"reset-customer-btn btn btn-default\" type=\"button\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t<table id=\"customerTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<th>客户名</th>\r\n");
      ...
      out.write("\r\n");
      out.write("\t<!-- 联系人区域 -->\r\n");
      out.write("\t<div id=\"contactList\" class=\"col-md-6\"></div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<script type=\"text/javascript\">\r\n");
      out.write("    var customerTable;\r\n");
      out.write("    var $customerTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      out.write("        var columnData = [ {\r\n");
      out.write("            \"data\" : \"name\"\r\n");
      out.write("        }, {\r\n");
      out.write("            \"data\" : \"region.name\"\r\n");
      out.write("        }, {\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("\r\n");
      out.write("        customerTable = $qingshixun.dataTable($('#customerTable'), {\r\n");
      out.write("            \"bDestroy\" : true,\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"customer/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      out.write("            \"columns\" : columnData,\r\n");
      out.write("            \"columnDefs\" : [ {\r\n");
      out.write("                \"data\" : null,\r\n");
      out.write("                \"defaultContent\" : \"<button type='button' title='修改' class='btn btn-primary btn-xs edit'>\" + \"<i class='fa fa-pencil'></i>\" + \"</button>\" + \"&nbsp;&nbsp;\" + \"<button type='button' title='删除' class='btn btn-danger btn-xs delete'>\" + \"<i class='fa fa-trash-o'></i>\" + \"</button>\" + \"&nbsp;&nbsp;\" + \"<button type='button' title='更改状态' class='btn btn-xs status'>\"\r\n");
      out.write("                        + \"<i class='fa fa-arrow-circle-up checkStatus'></i>\" + \"</button>\",\r\n");
      ...
      out.write("                // 点击客户列表某行加载该客户下的联系人\r\n");
      out.write("                $('td', row).click(function() {\r\n");
      out.write("                    initContactTable(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 渲染样式\r\n");
      ...
      out.write("                    editCustomer(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                //删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteCustomer(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 更改状态操作\r\n");
      out.write("                $('td', row).last().find(\".status\").click(function() {\r\n");
      out.write("                    changeCustomerStatus(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $customerTablePanel = $(\"#customerTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $customerTablePanel.find('.add-customer-btn').click(function() {\r\n");
      out.write("            loadContent(\"customer/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $customerTablePanel.find('.search-customer-btn').click(function() {\r\n");
      out.write("            customerTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $customerTablePanel.find('.reset-customer-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            customerTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      ...
      out.write("        $customerTablePanel.find('.excel-customer-btn').click(function() {\r\n");
      out.write("            $exportModal.modal(\"show\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 导出保存按钮\r\n");
      out.write("        $exportModal.find('.export-customer-btn').click(function() {\r\n");
      out.write("            // 获取导出文件名称\r\n");
      out.write("            var fileName = $exportModal.find('.file').val();\r\n");
      out.write("            if($.trim(fileName) == ''){\r\n");
      out.write("                toastr.warning('请输入导出文件名称！');\r\n");
      ...
      out.write("/customer/doExport/\" + fileName;\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 选择的行变换颜色\r\n");
      out.write("        $('#customerTable tbody').on('click', 'tr', function() {\r\n");
      out.write("            // 如果改行包含样式warning\r\n");
      out.write("            if ($(this).hasClass('warning')) {\r\n");
      out.write("                $(this).removeClass('warning');\r\n");
      out.write("            } else {\r\n");
      out.write("                customerTable.$('tr.warning').removeClass('warning');\r\n");
      out.write("                $(this).addClass('warning');\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 显示点击客户下的联系人\r\n");
      out.write("    function initContactTable(customerId) {\r\n");
      out.write("        $('#contactList').load('");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${ctx}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/contact/list/' + customerId, function(e) {\r\n");
      out.write("\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("        loadContent(\"customer/form/\" + customerId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除客户\r\n");
      ...
      out.write("                    url : 'customer/delete/' + customerId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该客户已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        // 刷新客户列表\r\n");
      out.write("                        customerTable.ajax.reload();\r\n");
      ...
      out.write("\r\n");
      out.write("    // 更改客户状态操作\r\n");
      out.write("    function changeCustomerStatus(customerId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该客户状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行修改操作\r\n");
      ...
      out.write("                    type : \"post\",\r\n");
      out.write("                    async : false,\r\n");
      out.write("                    url : 'customer/change/' + customerId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
