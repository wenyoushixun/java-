 ...
 * Generated at: 2018-01-15 04:14:46 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.purchaseorder;
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"purchaseOrderTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 采购订单列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-purchaseOrder-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"theme\" id=\"theme\" placeholder=\"采购订单主题\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-purchaseOrder-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-purchaseOrder-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"purchaseOrderTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>订单编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>主题</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>厂商名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>负责人</th>\r\n");
      ...
      out.write("    var purchaseOrderTable;\r\n");
      out.write("    var $purchaseOrderTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        purchaseOrderTable = $qingshixun.dataTable($('#purchaseOrderTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"purchaseorder/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editPurchaseOrder(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deletePurchaseOrder(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $purchaseOrderTablePanel = $(\"#purchaseOrderTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $purchaseOrderTablePanel.find('.add-purchaseOrder-btn').click(function() {\r\n");
      out.write("            loadContent(\"purchaseorder/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $purchaseOrderTablePanel.find('.search-purchaseOrder-btn').click(function() {\r\n");
      out.write("            purchaseOrderTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $purchaseOrderTablePanel.find('.reset-purchaseOrder-btn').click(function() {\r\n");
      out.write("            $(\"#theme\").val(\"\");\r\n");
      out.write("            purchaseOrderTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑采购订单\r\n");
      out.write("    function editPurchaseOrder(purchaseOrderId) {\r\n");
      out.write("        loadContent(\"purchaseorder/form/\" + purchaseOrderId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除采购订单\r\n");
      out.write("    function deletePurchaseOrder(purchaseOrderId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该采购订单？',\r\n");
      ...
      out.write("                    url : 'purchaseorder/delete/' + purchaseOrderId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该采购订单已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        purchaseOrderTable.ajax.reload();\r\n");
      out.write("                        toastr.success('采购订单删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
