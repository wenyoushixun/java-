 ...
 * Generated at: 2018-01-15 04:32:45 UTC
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("<!-- 产品类别编辑窗口 -->\r\n");
      out.write("<div class=\"modal fade\" id=\"categoryModal\" tabindex=\"-1\" department=\"dialog\" aria-hidden=\"true\">\r\n");
      out.write("\t<div class=\"modal-dialog\">\r\n");
      out.write("\t\t<div class=\"modal-content\">\r\n");
      out.write("\t\t\t<div id=\"categoryBody\" class=\"modal-content\"></div>\r\n");
      out.write("\t\t</div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- 产品类别列表 -->\r\n");
      out.write("<section id=\"categoryTablePanel\">\r\n");
      out.write("\t<div class=\"row\">\r\n");
      out.write("\t\t<article class=\"col-md-12\">\r\n");
      out.write("\t\t\t<div class=\"widget \">\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body-toolbar\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"add-category-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"name\" id=\"name\" placeholder=\"类别名称\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-category-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-category-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<!-- widget content -->\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"categoryTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("    var categoryTable;\r\n");
      out.write("    var $categoryTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        //初始化表格信息\r\n");
      out.write("        categoryTable = $qingshixun.dataTable($('#categoryTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"category/page/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editCategory(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteCategory(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 更改状态操作\r\n");
      out.write("                $('td', row).last().find(\".status\").click(function() {\r\n");
      out.write("                    changeCategoryStatus(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $categoryTablePanel = $(\"#categoryTablePanel\");\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $categoryTablePanel.find('.add-category-btn').click(function() {\r\n");
      out.write("            editCategory(0);\r\n");
      out.write("        });\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $categoryTablePanel.find('.search-category-btn').click(function() {\r\n");
      out.write("            categoryTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $categoryTablePanel.find('.reset-category-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            categoryTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑类别\r\n");
      out.write("    function editCategory(categoryId) {\r\n");
      out.write("        $(\"#categoryModal\").modal(\"show\");\r\n");
      out.write("        $('#categoryBody').load('");
      ...
      out.write("/category/form/' + categoryId, function(e) {\r\n");
      out.write("\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除类别\r\n");
      out.write("    function deleteCategory(categoryId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该类别？',\r\n");
      ...
      out.write("                    url : 'category/delete/' + categoryId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
      out.write("                    success : function(result) {\r\n");
      out.write("                        // 如果返回的状态是-1表示产品类别已经被引用不能删除\r\n");
      out.write("                        if (result.status == -1) {\r\n");
      out.write("                            toastr.error('该类别被产品引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        categoryTable.ajax.reload();\r\n");
      out.write("                        toastr.success('类别删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("\r\n");
      out.write("    // 更改类别状态操作\r\n");
      out.write("    function changeCategoryStatus(categoryId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该类别状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
