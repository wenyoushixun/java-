 ...
 * Generated at: 2018-01-15 04:14:49 UTC
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"issueTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 问题单列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-issue-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"title\" id=\"title\" placeholder=\"问题单名称\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-issue-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-issue-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"issueTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>问题单编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>标题</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>负责人</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>状态</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>操作</th>\r\n");
      ...
      out.write("    var issueTable;\r\n");
      out.write("    var $issueTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        issueTable = $qingshixun.dataTable($('#issueTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"issue/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                aoData.title = $(\"#title\").val();\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $issueTablePanel = $(\"#issueTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $issueTablePanel.find('.add-issue-btn').click(function() {\r\n");
      out.write("            loadContent(\"issue/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $issueTablePanel.find('.search-issue-btn').click(function() {\r\n");
      out.write("            issueTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $issueTablePanel.find('.reset-issue-btn').click(function() {\r\n");
      out.write("            $(\"#title\").val(\"\");\r\n");
      out.write("            issueTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑问题单\r\n");
      out.write("    function editIssue(issueId) {\r\n");
      out.write("        loadContent(\"issue/form/\" + issueId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除问题单\r\n");
      out.write("    function deleteIssue(issueId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该问题单？',\r\n");
      ...
      out.write("                    url : 'issue/delete/' + issueId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该问题单已被订单引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        issueTable.ajax.reload();\r\n");
      out.write("                        toastr.success('问题单删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("\r\n");
      out.write("    // 更改问题单状态操作\r\n");
      out.write("    function changeIssueStatus(issueId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该问题单状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
      ...
      out.write("                    type : \"post\",\r\n");
      out.write("                    async : false,\r\n");
      out.write("                    url : 'issue/change/' + issueId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
