...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"quotationTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 报价单列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-quotation-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"title\" id=\"title\" placeholder=\"报价单名称\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-quotation-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-quotation-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"quotationTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>报价单编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>标题</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>客户名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>销售机会名称</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>负责人</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>状态</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>操作</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tr>\r\n");
      ...
      out.write("    var quotationTable;\r\n");
      out.write("    var $quotationTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        }, {\r\n");
      out.write("            \"data\" : \"opportunity.name\"\r\n");
      out.write("        }, {\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        quotationTable = $qingshixun.dataTable($('#quotationTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"quotation/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editQuotation(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteQuotation(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $quotationTablePanel = $(\"#quotationTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $quotationTablePanel.find('.add-quotation-btn').click(function() {\r\n");
      out.write("            loadContent(\"quotation/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $quotationTablePanel.find('.search-quotation-btn').click(function() {\r\n");
      out.write("            quotationTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $quotationTablePanel.find('.reset-quotation-btn').click(function() {\r\n");
      out.write("            $(\"#title\").val(\"\");\r\n");
      out.write("            quotationTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑报价单\r\n");
      out.write("    function editQuotation(quotationId) {\r\n");
      out.write("        loadContent(\"quotation/form/\" + quotationId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除报价单\r\n");
      out.write("    function deleteQuotation(quotationId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该报价单？',\r\n");
      ...
      out.write("                    url : 'quotation/delete/' + quotationId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该报价单已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        quotationTable.ajax.reload();\r\n");
      out.write("                        toastr.success('报价单删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
