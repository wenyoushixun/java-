 ...
 */
package org.apache.jsp.WEB_002dINF.views.prospective;
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"prospectiveTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 潜在客户列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-prospective-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"name\" id=\"name\" placeholder=\"潜在客户姓名\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-prospective-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-prospective-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"prospectiveTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("    var prospectiveTable;\r\n");
      out.write("    var $prospectiveTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        prospectiveTable = $qingshixun.dataTable($('#prospectiveTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"prospective/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editProspective(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteProspective(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $prospectiveTablePanel = $(\"#prospectiveTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $prospectiveTablePanel.find('.add-prospective-btn').click(function() {\r\n");
      out.write("            loadContent(\"prospective/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $prospectiveTablePanel.find('.search-prospective-btn').click(function() {\r\n");
      out.write("            prospectiveTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $prospectiveTablePanel.find('.reset-prospective-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            prospectiveTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑营销活动\r\n");
      out.write("    function editProspective(prospectiveId) {\r\n");
      out.write("        loadContent(\"prospective/form/\" + prospectiveId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除营销活动\r\n");
      out.write("    function deleteProspective(prospectiveId) {\r\n");
      out.write("        $.confirm({\r\n");
      ...
      out.write("                    url : 'prospective/delete/' + prospectiveId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该潜在客户已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        prospectiveTable.ajax.reload();\r\n");
