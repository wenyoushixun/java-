 ...
 * Generated at: 2018-01-15 04:14:51 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.problem;
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"problemTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 常见问题列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-problem-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"problem\" id=\"problem\" placeholder=\"常见问题\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-problem-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-problem-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"problemTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>常见问题编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>问题</th>\r\n");
      ...
      out.write("    var problemTable;\r\n");
      out.write("    var $problemTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        problemTable = $qingshixun.dataTable($('#problemTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"problem/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editproblem(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteproblem(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("            },\r\n");
      ...
      out.write("                aoData.problem = $(\"#problem\").val();\r\n");
      out.write("            }\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $problemTablePanel = $(\"#problemTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $problemTablePanel.find('.add-problem-btn').click(function() {\r\n");
      out.write("            loadContent(\"problem/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $problemTablePanel.find('.search-problem-btn').click(function() {\r\n");
      out.write("            problemTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $problemTablePanel.find('.reset-problem-btn').click(function() {\r\n");
      out.write("            $(\"#problem\").val(\"\");\r\n");
      out.write("            problemTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑常见问题\r\n");
      out.write("    function editproblem(problemId) {\r\n");
      out.write("        loadContent(\"problem/form/\" + problemId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除常见问题\r\n");
      out.write("    function deleteproblem(problemId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该常见问题？',\r\n");
      ...
      out.write("                    url : 'problem/delete/' + problemId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该常见问题已被订单引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        problemTable.ajax.reload();\r\n");
      out.write("                        toastr.success('常见问题删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 更改常见问题状态操作\r\n");
      out.write("    function changeproblemStatus(problemId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该常见问题状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
      ...
      out.write("                    type : \"post\",\r\n");
      out.write("                    async : false,\r\n");
      out.write("                    url : 'problem/change/' + problemId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
