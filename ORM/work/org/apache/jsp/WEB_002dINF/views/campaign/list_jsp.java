 ...
 * Generated at: 2018-01-15 04:33:17 UTC
 * Note: The last modified time of this file was set to
 *       the last modified time of the source file after
 *       generation to assist with modification tracking.
 */
package org.apache.jsp.WEB_002dINF.views.campaign;
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"campaignTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 营销活动列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-campaign-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"name\" id=\"name\" placeholder=\"营销活动名称\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-campaign-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-campaign-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"campaignTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>营销活动编号</th>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<th>营销活动名称</th>\r\n");
      ...
      out.write("    var campaignTable;\r\n");
      out.write("    var $campaignTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        campaignTable = $qingshixun.dataTable($('#campaignTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"campaign/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                    editCampaign(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteCampaign(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $campaignTablePanel = $(\"#campaignTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $campaignTablePanel.find('.add-campaign-btn').click(function() {\r\n");
      out.write("            loadContent(\"campaign/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $campaignTablePanel.find('.search-campaign-btn').click(function() {\r\n");
      out.write("            campaignTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $campaignTablePanel.find('.reset-campaign-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            campaignTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("    // 编辑营销活动\r\n");
      out.write("    function editCampaign(campaignId) {\r\n");
      out.write("        loadContent(\"campaign/form/\" + campaignId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除营销活动\r\n");
      out.write("    function deleteCampaign(campaignId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该营销活动？',\r\n");
      ...
      out.write("                    url : 'campaign/delete/' + campaignId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该营销活动已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        campaignTable.ajax.reload();\r\n");
      out.write("                        toastr.success('营销活动删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 更改营销活动状态操作\r\n");
      out.write("    function changeCampaignStatus(campaignId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该营销活动状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
      ...
      out.write("                    type : \"post\",\r\n");
      out.write("                    async : false,\r\n");
      out.write("                    url : 'campaign/change/' + campaignId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
