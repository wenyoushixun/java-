 ...
 * Generated at: 2018-01-15 04:14:38 UTC
...
return;
    ...
    try {
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<section id=\"productTablePanel\" class=\"\">\r\n");
      out.write("\t<!-- 产品列表 -->\r\n");
      ...
      out.write("\t\t\t\t\t\t<button class=\"add-product-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"name\" id=\"name\" placeholder=\"产品名称\" type=\"text\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"search-product-btn btn btn-success\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-search\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<button class=\"reset-product-btn btn btn-default\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-mail-reply\"></i>\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body no-padding\">\r\n");
      out.write("\t\t\t\t\t\t<table id=\"productTable\" class=\"table table-striped table-hover\">\r\n");
      out.write("\t\t\t\t\t\t\t<thead>\r\n");
      out.write("\t\t\t\t\t\t\t\t<tr>\r\n");
      ...
      out.write("    var productTable;\r\n");
      out.write("    var $productTablePanel;\r\n");
      out.write("    $(function() {\r\n");
      out.write("        // 定义数据列\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        productTable = $qingshixun.dataTable($('#productTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      out.write("                \"url\" : \"product/list/data\",\r\n");
      out.write("                \"type\" : \"POST\"\r\n");
      out.write("            },\r\n");
      ...
      out.write("                // 渲染样式\r\n");
      out.write("                if (data.status.code == \"PROS_Sale\") {\r\n");
      ...
      out.write("\r\n");
      out.write("                // 显示图片\r\n");
      out.write("                $('td', row).eq(4).html(\"<img width='50px;' height='50px;' src=");
      ...
      out.write("                    editProduct(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 删除操作\r\n");
      out.write("                $('td', row).last().find(\".delete\").click(function() {\r\n");
      out.write("                    deleteProduct(data.id);\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("                // 更改状态操作\r\n");
      out.write("                $('td', row).last().find(\".status\").click(function() {\r\n");
      out.write("                    changeProductStatus(data.id);\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $productTablePanel = $(\"#productTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $productTablePanel.find('.add-product-btn').click(function() {\r\n");
      out.write("            loadContent(\"product/form/0\");\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $productTablePanel.find('.search-product-btn').click(function() {\r\n");
      out.write("            productTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $productTablePanel.find('.reset-product-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            productTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      ...
      out.write("        loadContent(\"product/form/\" + productId);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除产品\r\n");
      ...
      out.write("                    url : 'product/delete/' + productId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该产品已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        productTable.ajax.reload();\r\n");
      out.write("                        toastr.success('产品删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("\r\n");
      out.write("    // 更改产品状态操作\r\n");
      out.write("    function changeProductStatus(productId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该产品状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
      ...
      out.write("                    type : \"post\",\r\n");
      out.write("                    async : false,\r\n");
      out.write("                    url : 'product/change/' + productId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      out.write("                    dataType : \"json\",\r\n");
      out.write("                    success : function(result) {\r\n");
      out.write("                        productTable.ajax.reload();\r\n");
      out.write("                        toastr.success('状态修改成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      out.write("            cancel : function() {\r\n");
