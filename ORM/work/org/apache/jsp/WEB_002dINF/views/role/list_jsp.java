 ...
 * Generated at: 2018-01-15 04:10:53 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t<div id=\"roleBody\" class=\"modal-content\"></div>\r\n");
      out.write("\t</div>\r\n");
      out.write("</div>\r\n");
      out.write("\r\n");
      out.write("<!-- 角色列表 -->\r\n");
      out.write("<section id=\"roleTablePanel\" class=\"\">\r\n");
      out.write("\t<div class=\"row\">\r\n");
      out.write("\t\t<article class=\"col-md-12\">\r\n");
      out.write("\t\t\t<div class=\"widget \" >\r\n");
      out.write("\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t<div class=\"widget-body-toolbar\">\r\n");
      out.write("\t\t\t\t\t\t<button class=\"add-role-btn btn btn-primary pull-left\" type=\"button\">\r\n");
      out.write("\t\t\t\t\t\t\t<i class=\"fa fa-plus\"></i> 新增\r\n");
      out.write("\t\t\t\t\t\t</button>\r\n");
      out.write("\t\t\t\t\t\t<input class=\"form-control list-search\" name=\"name\" id=\"name\" placeholder=\"角色名...\" type=\"text\">\r\n");
      ...
      out.write("        // 初始化表格信息\r\n");
      out.write("        roleTable = $qingshixun.dataTable($('#roleTable'), {\r\n");
      out.write("            \"ajax\" : {\r\n");
      ...
      out.write("\r\n");
      out.write("                roleBodyable : false, // 禁止排序\r\n");
      ...
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        $roleTablePanel = $(\"#roleTablePanel\");\r\n");
      out.write("\r\n");
      out.write("        // 初始化新增按钮\r\n");
      out.write("        $roleTablePanel.find('.add-role-btn').click(function() {\r\n");
      out.write("            editRole(0);\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化查询按钮\r\n");
      out.write("        $roleTablePanel.find('.search-role-btn').click(function() {\r\n");
      out.write("            roleTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("\r\n");
      out.write("        // 初始化重置按钮\r\n");
      out.write("        $roleTablePanel.find('.reset-role-btn').click(function() {\r\n");
      out.write("            $(\"#name\").val(\"\");\r\n");
      out.write("            roleTable.ajax.reload();\r\n");
      out.write("        });\r\n");
      out.write("    });\r\n");
      out.write("\r\n");
      out.write("    // 编辑角色\r\n");
      out.write("    function editRole(roleId) {\r\n");
      out.write("        $(\"#addRoleModal\").modal(\"show\");\r\n");
      out.write("        $('#roleBody').load('");
      ...
      out.write("/role/form/' + roleId, function(e) {\r\n");
      out.write("\r\n");
      out.write("        });\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    // 删除角色\r\n");
      out.write("    function deleteRole(roleId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否确认删除该角色？',\r\n");
      ...
      out.write("                    url : 'role/delete/' + roleId,\r\n");
      out.write("                    data : {\r\n");
      out.write("\r\n");
      out.write("                    },\r\n");
      ...
      out.write("                            toastr.error('该角色已被引用,不能删除！');\r\n");
      out.write("                            return;\r\n");
      out.write("                        }\r\n");
      out.write("                        roleTable.ajax.reload();\r\n");
      out.write("                        toastr.success('角色删除成功！');\r\n");
      out.write("                    }\r\n");
      out.write("                });\r\n");
      out.write("            },\r\n");
      ...
      out.write("\r\n");
      out.write("    // 更改角色状态操作\r\n");
      out.write("    function changeRoleStatus(roleId) {\r\n");
      out.write("        $.confirm({\r\n");
      out.write("            title : false,\r\n");
      out.write("            content : '是否修改该角色状态？',\r\n");
      out.write("            confirmButton : '确认',\r\n");
      out.write("            cancelButton : '取消',\r\n");
      out.write("            confirm : function() {\r\n");
      out.write("                // 执行删除\r\n");
