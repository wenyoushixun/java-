...
<html>
	...
	<body>
		...
		<div id="newNoticeForm" style="display: none;">
			...
			<form id="noticeForm">
				<table border="0">
					...
					<tr><td colspan="6" align="center"><input type="reset"/>&nbsp;<input type="button" onclick="addNotice(2);" value="发布"/></td></tr>
				</table>
			</form>
			</fieldset>
		</div>
		...
		<table border='1' cellpadding='0' cellspacing='0' align="center" width="99%" class="mgr">
			...
			<tr></tr>
			<s:if test="notices.size() eq 0">您没有发布过通知</s:if>
		</table>
	</body>
</html>