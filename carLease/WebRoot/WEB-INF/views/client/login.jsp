...
<html>
	...
	<body>
		...
		<div class="login" style="display: block;">
			...
			<form name="loginform" method="post" action="${ctx}/rest/client/user/login" id="loginform" onsubmit="return dosub()">
				<div class="form_holder">
					...
					<div class="form_line">
						<button type="submit" class="btn btn-normal btn-red" id="submit">登 录</button>
					</div>

					<div class="form_line form_footer f13">
						<a href="${ctx}/rest/client/user/toReg" class="j_reg">账号注册</a>
					</div>
